...
const Dashboard = () => {
    ...
    if (!session || !session.user || (session.user.email !== 'debmalyasen37@gmail.com' && session.user.email !== 'souvik007b@gmail.com' && session.user.email !== "yashverdhan01@gamil.com" && session.user.email !== "debmalyasen15@gmail.com" && session.user.email !== "test@gmail.com")) {
        return (
